...
__all__ = ["MaskFormerSemanticDatasetMapperWithUNO"]
...
class MaskFormerSemanticDatasetMapperWithUNO:
    ...
    def __init__(
        ...
        *,
        ...
        self.anomaly_image_paths = sorted(glob.glob(root + '/images/training/*.jpg'))
        self.anomaly_annotation_paths = sorted(glob.glob(root + '/annotations/training/*.png'))
