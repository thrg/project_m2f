...
parser.add_argument('--input_folder', type=str, default='/home/chenga/datasets/street_obstacle_sequences', help='Path to folder with images to be run.')
