...
def calculate_anomaly_scores(args):
    ...
    # SWIN-L
    cfg.merge_from_file('./configs/cityscapes/semantic-segmentation/swin/maskformer2_swin_large_IN21k_384_bs12_2k_city+vistas_uno.yaml')
    cfg.MODEL.WEIGHTS = './model_weights/model_0001999_uno.pth'
    ...
    for image_name in tqdm(images):
        ...
        np.save(out_path, s_m2f_uno.detach().cpu().numpy())
...
def run_uno(args):
    ...
    for image_name in tqdm(images):
        ...
        np.save(anomaly_score_path, s_m2f_uno.detach().cpu().numpy())
